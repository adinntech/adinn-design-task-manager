...
@section('workspace-title','BD Dashboard')
...
<div class="bd-dashboard">
    <div class="bd-dash-head">
        <div>
            ...
            <p>All important BD task information in one place.</p>
        </div>
        <div class="bd-dash-actions">
            <a class="bd-dash-btn secondary" href="{{ route('bd.tasks.index') }}">View All Tasks</a>
            <a class="bd-dash-btn primary" href="{{ route('bd.tasks.create') }}">+ Create Task</a>
        </div>
    </div>

    <div class="bd-kpis">
        <div class="bd-kpi"><div class="bd-kpi-label">Total Tasks</div><div class="bd-kpi-value">{{ $stats['total'] }}</div><div class="bd-kpi-note">Tasks created by you</div></div>
        <div class="bd-kpi"><div class="bd-kpi-label">Assigned</div><div class="bd-kpi-value">{{ $stats['assigned'] }}</div><div class="bd-kpi-note">Awaiting Designer action</div></div>
        ...
        <div class="bd-kpi"><div class="bd-kpi-label">Pending Approval</div><div class="bd-kpi-value">{{ $stats['pending_approval'] }}</div><div class="bd-kpi-note">Open requests</div></div>
    ...
    <section class="bd-card">
        <div class="bd-card-head">
            ...
            <a class="bd-card-link" href="{{ route('bd.tasks.index') }}">View All Tasks</a>
        </div>
        ...
        <div class="bd-table-wrap">
            <table class="bd-table">
                ...
                @forelse($recentTasks as $task)
                    ...
                    @endphp
                    <tr>
                        <td><a class="bd-task-link" href="{{ route('bd.tasks.show',$task) }}">{{ $task->task_id }}</a></td>
                ...
                @empty
                    <tr><td colspan="9"><div class="bd-empty">No tasks have been created yet.</div></td></tr>
                @endforelse
                </tbody>
            </table>
        </div>
                ...
                @forelse($recentRequests as $request)
                    <div class="bd-recent-request">
                        ...
                        <div class="bd-recent-request-sub">
                            ...
                            · {{ $request->requester?->name ?? 'Designer' }}
