...
<div class="dh-zone-inner">
    ...
    <div class="dh-kpis">
        ...
        <a class="dh-kpi dh-kpi-link dh-kpi-accent" href="{{ route('bd.tasks.index', ['focus' => 'pending_bd_approval']) }}"><div class="dh-kpi-icon">✎</div><div class="dh-kpi-label">Waiting for Your Confirmation</div><div class="dh-kpi-value">{{ $stats['pending_bd_approval'] }}</div><div class="dh-kpi-note">New tickets created by Designers</div></a>
