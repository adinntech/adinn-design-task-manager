...
<div class="dh-zone-inner">
    ...
    <section class="dh-card">
        ...
        <div class="dh-table-wrap">
            <table class="dh-table">
                <thead>
                <tr><th>Designer</th><th>Task</th><th>Project Number</th><th>Rework #</th><th>Rework Assigned At</th><th>Rework Creative Count</th><th>Sent By (BD)</th><th>Current Status</th></tr>
                </thead>
                <tbody>
                ...
                @empty
                    <tr><td colspan="8"><div class="dh-empty">No rework records found.</div></td></tr>
                @endforelse
                </tbody>
            </table>
        </div>
    ...
    <section class="dh-card">
        ...
        <div class="dh-table-wrap">
            <table class="dh-table">
                <thead>
                <tr><th>Task</th><th>Project Number</th><th>Designer</th><th>Assigned BD</th><th>Assigned At</th><th>Due Date</th><th>Completed At</th><th>Duration</th><th>Rating</th><th>Rework</th></tr>
                </thead>
                <tbody>
                ...
                @empty
                    <tr><td colspan="10"><div class="dh-empty">No completions recorded yet.</div></td></tr>
                @endforelse
                </tbody>
            </table>
        </div>
