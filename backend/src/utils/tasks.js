...
function canSeeTask(user, task) {
  ...
  if (user.role === 'bd' || user.role === 'manager') return task.assigned_by === user.id;
...
module.exports = { STATUS_LABELS, statusLabel, canSeeTask, enrichTask, safePerson, isOverdue, applyComputedStatus };
